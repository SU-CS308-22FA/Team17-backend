...
from base.serializers import PostCreateSerializer, PostListSerializer, PostUpdateSerializer, PostDetailSerializer, PostListAllSerializer
...
def post_create_view(request):
    ...
    user = request.user
    data = request.data
    data['author'] = user.id  # Adding User ID Of The Author
